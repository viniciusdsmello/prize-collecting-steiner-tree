...
for folder in ['PCSPG-PUCNU']:
    INSTANCES_PATH_PREFIX = './data/instances/benchmark/' + folder
    ...
    df_score_aco.to_csv(os.path.join(INSTANCES_PATH_PREFIX, 'ACO_WITH_NORMALIZATION.csv'))
